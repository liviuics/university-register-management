...
public class AddDisciplina extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adauga disciplina");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(name.equals("")){
            JOptionPane.showMessageDialog(null, "Introduceti codul");
        }else if(autor.equals("")){
            JOptionPane.showMessageDialog(null, "Introduceti numele");
        }else if(an_lansare.equals("")){
            JOptionPane.showMessageDialog(null, "Introduceti ore curs");
        }else if(editura.equals("")){
            JOptionPane.showMessageDialog(null, "Introduceti ore S/L");
        }else if(pret.equals("")){
            JOptionPane.showMessageDialog(null, "Introduceti nr credite");
        }else{
        
            PreparedStatement ps;
            String query="INSERT INTO ics.disciplina(cod_disciplina, denumire, ore_curs, ore_sl, nr_credite) VALUES (?,?,?,?,?)";
            try{
                ...
                if(ps.executeUpdate()>0){
                        JOptionPane.showMessageDialog(null,"Disciplina adaugata cu succes");
                        jTextField1.setText("");
                        jTextField2.setText("");
                        jTextField3.setText("");
                        jTextField4.setText("");
